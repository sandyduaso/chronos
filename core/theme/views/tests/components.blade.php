...
@section('page:content')
  ...
  <div data-sticky="#navbar-page-header"></div>
  <div id="navbar-page-header" data-sticky-class="sticky bg-white shadow-sm" class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container">
      <a href="{{ url()->current() }}" class="navbar-brand">{{ $application->site->title }}</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav">
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" id="themes" aria-expanded="false">{{ __('Pricing') }} <span class="caret"></span></a>
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="download">
              ...
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="../_vendor/bootstrap/dist/css/bootstrap.min.css">bootstrap.min.css</a>
              <a class="dropdown-item" href="../_vendor/bootstrap/dist/css/bootstrap.css">bootstrap.css</a>
            </div>
          </li>
        </ul>
  ...
  <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-5">
          ...
          <div class="bs-component" style="margin-bottom: 15px;">
            <div class="btn-group btn-group-toggle" data-toggle="buttons">
              <label class="btn btn-primary active">
                <input checked="" autocomplete="off" type="checkbox"> Active
              </label>
          ...
          <div class="bs-component" style="margin-bottom: 15px;">
            <div class="btn-group btn-group-toggle" data-toggle="buttons">
              <label class="btn btn-primary active">
                <input name="options" id="option1" autocomplete="off" checked="" type="radio"> Active
              </label>
              <label class="btn btn-primary">
          ...
          <form class="bs-component">
            ...
            <div class="form-group">
              <fieldset>
                ...
                <input class="form-control" id="readOnlyInput" placeholder="Readonly input here…" readonly="" type="text">
              </fieldset>
            </div>
          ...
          <div class="bs-component">
            <fieldset>
              ...
              <div class="form-group">
                ...
                <div class="custom-control custom-radio">
                  <input id="customRadio3" name="customRadio" class="custom-control-input" disabled="" type="radio">
    ...
    <footer id="footer" class="p-6">
      <div class="row">
        <div class="col-lg-12">
          <div class="text-divider">{{ __('End of File') }}</div>
        </div>
      </div>
