...
class MigrationNewCommand extends BaseCommand
{
     ...
     * @var string
     */
    protected $signature = 'migration:new
        {name : The name of the migration.}
        {--m|module= : The module the migration belongs to.}
    ...
    public function handle()
    {
        ...
        $module = $this->input->getOption('module') ?: false;
        ...
        if (! $module) {
            $module = $this->choice("Specify in what module to save the migration '$name'", $this->modules());
        }

        $this->input->setOption('realpath', true);
        $this->input->setOption('path', $this->getModuleMigrationPath($module));
    ...
    protected function getMigrationPath()
    {
        if (! is_null($targetPath = $this->input->getOption('path'))) {
            return ! $this->usingRealPath()
                            ? $this->webApp->basePath().'/'.$targetPath
                            : $targetPath;
        }
