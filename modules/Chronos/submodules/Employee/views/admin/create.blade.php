  ...
  <div class="container-fluid">
    <form action="{{ route('users.store') }}" method="POST">
      ...
      <nav id="page-header" data-sticky-class="sticky bg-workspace shadow-sm" class="navbar row px-3">
        <h1 class="page-title">{{ __('Add Employee') }}</h1>
                ...
                <table class="table table-no-border" data-dynamic-container>
                  <tbody>
                    ...
                    <tr data-dynamic-item-template>
                      ...
                      <td>
                        <div class="form-group mb-0">
                          <input type="text" data-name="details[#][key]" class="form-control" value="" placeholder="{{ __('Key') }}">
                        </div>
                      </td>
                      <td>
                        <div class="form-group mb-0">
                          <input type="text" data-name="details[#][value]" class="form-control" value="" autocomplete="off" placeholder="{{ __('Value') }}">
                        </div>
                      </td>
                      <td class="pr-5 justify-content-end d-flex">
                        <div class="w-100"></div>
